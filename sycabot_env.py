...
class SycaBotEnv(gym.Env):
    ...
    def __init__( # parameters to deit
        ...
        robot_radius=0.08,
        pickup_reward=400.0,
        delivery_reward=2000.0,
        smooth_action_weight=0.20,
        turn_smooth_weight=0.10,
        jerk_weight=0.04,
        direction_flip_weight=0.05,
        boundary_death_penalty=50.0,
        task_progress_reward_weight=12.0,
        exit_progress_reward_weight=60.0,
