...
class SycaBotEnv(gym.Env):
    ...
    def __init__( # parameters to deit
        ...
        robot_radius=0.08,
        pickup_reward=300.0,
        delivery_reward=2500.0,
        smooth_action_weight=0.15,
        turn_smooth_weight=0.08,
        jerk_weight=0.03,
        direction_flip_weight=0.04,
        boundary_death_penalty=60.0,
        task_progress_reward_weight=10.0,
        exit_progress_reward_weight=70.0,
