...
class SycaBotEnv(gym.Env):
    ...
    def __init__( # parameters to deit
        ...
        num_tasks=2,
        max_steps=1000,
        fire_spread_prob=0.10,
        fire_kill_prob=0.2,
        fire_cell_size=0.08,
        robot_radius=0.08,
        pickup_reward=500.0,
        delivery_reward=1800.0,
        smooth_action_weight=0.25,
        turn_smooth_weight=0.15,
        jerk_weight=0.06,
        direction_flip_weight=0.08,
        boundary_death_penalty=50.0,
        task_progress_reward_weight=15.0,
        exit_progress_reward_weight=45.0,
